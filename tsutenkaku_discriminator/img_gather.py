...
num = 800   #ここに画像枚数 int型 できるだけ20の倍数にしてくれると助かります
word = "通天閣"  #ここに画像の検索ワード str型
path_1 = "./data/tsutenkaku/"  #ここに一つ目の保存場所を入力　注意点として\を/に置換すること また/で終わること　例(desktop):C:/Users/ユーザー名/Desktop/
path_2 = "./data/tsutenkaku_valid/"  #ここに二つ目の保存場所を入力　注意点として\を/に置換すること また/で終わること　例(desktop):C:/Users/ユーザー名/Desktop/
